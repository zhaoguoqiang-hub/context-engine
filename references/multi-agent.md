...
```
~/.agents/skills/context-engine/memory/   ← 数据层（唯一）
...
~/.codex/skills/context-engine → symlink → ~/.agents/skills/context-engine
...
```bash
ln -sfn ~/.agents/skills/context-engine ~/.codex/skills/context-engine
```
